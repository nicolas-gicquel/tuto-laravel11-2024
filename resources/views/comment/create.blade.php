    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <form class="col-4 mx-auto" action="{{ route('comments.store')}}" method="POST">
                @csrf
                <h2 class="text-center">Création d'un commentaire</h1>
                <div class="form-group">
                    <label for="content">Contenu</label>
                    {{-- <input required type="text" class="form-control" placeholder="modifier" name="pseudo"
                        value="{{ $user->pseudo }}" id="pseudo"> --}}
                    <textarea required class="form-control" name="content"  cols="30" rows="10">Contenu du commentaire</textarea>
                </div>
                ...
                <div class="form-group">
                    <label for="tags">Tags</label>
                    <input required type="hidden" class="form-control" name="post_id" value="1"
                        id="tags">
